...
const socket = io({
    auth: {
        ...
        // eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1dWlkIjoiM2VhOTNlNTctYjg1Ni00OGYyLTkwMmMtM2Y2Njg5MWMzODk3IiwiaWF0IjoxNjcxODYyNzU5fQ.S6ONCS - PwaJqyHXeDyuN4OmblNglSdraHu8yWdpF9oI
    }
});
...
socket.on("warnings", (warning_notifications) => {
    console.log(warning_notifications);
    // ht-update l list hena ya hamadaa
})

socket.on("penalties", (penalties_notifications) => {
    console.log(penalties_notifications);
    // ht-update l list hena ya hamadaa
})
